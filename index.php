...
$index = get_index();
 ...
 if(isset($_GET["id"])){
  ...
  foreach($index as $id => $name){
    echo "<ul><li>$id<a href=form.php?id=$id=>" . " - " . "$name</a></li></ul>";
  }
...
<body>
  ...
  <input type="radio" name="location" value="" id="from-eu"/><label for="from-eu"> EU </label><br>
  <input type="radio" name="location" value="" id="from-noneu"/> <label for="from-noneu"> Non-EU </label><br>
